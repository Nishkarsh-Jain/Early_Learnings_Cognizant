const principalAmt = document.getElementById("principalAmount");
const interestRateYear = document.getElementById("interestRate");
const tenureMnth = document.getElementById("tenure");
...
function EstimateFixedInterestLoan() {
    const principalAmount = Number(principalAmt.value);
    const interestRateYear = Number(interestRateYear.value);
    const tenureMonth = Number(tenureMnth.value);
